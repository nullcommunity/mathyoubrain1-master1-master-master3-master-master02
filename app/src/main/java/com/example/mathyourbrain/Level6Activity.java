...
public class Level6Activity extends AppCompatActivity {
    ...
    public void questionManager() {
        ...
        if (questionNumber < 5) {
            ...
            if (questionNumber == 1) {
                imageView.setImageResource(R.drawable.lvl6question1);
                if (correctAnswer == 1) {
            ...
            if (questionNumber == 2) {
                imageView.setImageResource(R.drawable.lvl6question2);
                if (correctAnswer == 1) {
            ...
            if (questionNumber == 3) {
                imageView.setImageResource(R.drawable.lvl6question3);
                if (correctAnswer == 1) {
            ...
            if (questionNumber == 4) {
                imageView.setImageResource(R.drawable.lvl6question4);
                if (correctAnswer == 1) {
            ...
            if (questionNumber == 5) {
                imageView.setImageResource(R.drawable.lvl6question5);
                if (correctAnswer == 1) {
